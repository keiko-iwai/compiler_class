...
project: tokens.cpp parser.cpp
	clang++ -Xlinker --export-dynamic -g parser.cpp tokens.cpp processor.cpp codegen.cpp runtime.cpp main.cpp -o compiler `llvm-config --cxxflags --ldflags --system-libs --libs all`
